...
export type Invoice = { id: number; business_id: number; customer_id: number | null; quote_id: number | null; number: string; status: string; issued_date: string; due_date: string | null; total: number; paid_at: string | null; payment_link: string | null; payment_ref?: string | null; created_at: string };
